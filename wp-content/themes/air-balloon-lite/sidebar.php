...
?>
	...
	<section id="sidebar" class="secondary clearfix" role="complementary">
		...
		<?php
			...
			<aside class="widget">
				<h3 class="widgettitle"><?php _e('Widget Area', 'airballoon-lite'); ?></h3>
				<div class="textwidget">
					<p><?php _e('There are no active widgets to be displayed. Please go to Appearance -> Widgets to setup your sidebar.', 'airballoon-lite'); ?></p>
				</div>
			</aside>
